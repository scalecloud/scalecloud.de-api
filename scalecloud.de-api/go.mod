...
replace github.com/scalecloud/scalecloud.de-api/tree/main/firebase => ../firebase

replace github.com/scalecloud/scalecloud.de-api/tree/main/mongo => ../mongo

replace github.com/scalecloud/scalecloud.de-api/tree/main/stripe => ../stripe
